...
public class GestionaJornadas {  
	...
	public static void main(String[] args) {
		...
		logger.debug(eventoDao.duraMas91());
		logger.debug(eventoDao.partipantesporEventos());
		logger.debug(participanteDao.participantesOrdenadosapellidoAsc());
		//logger.debug(ubicacionDao.buscarPorUbi("Sala laboratorio"));
	}
